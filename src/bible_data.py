...
BIBLE_BOOKS = {
    'Genesis': [
        1, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33,
    ...
    'Psalms': [
        ...
        13, 11, 5, 26, 17, 11, 9, 14, 20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17,
        12, 8, 12, 11, 10, 13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72,
        13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12,
        9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2,
    ...
    'Isaiah': [
        ...
        6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22,
        8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12,
...
def get_chapter_count(book_name):
    ...
    if book_name in BIBLE_BOOKS:
        return len(BIBLE_BOOKS[book_name])
    return 0
...
def get_verse_count(book_name, chapter):
    ...
    if (
        ...
        and
        chapter in range(1, 1 + get_chapter_count(book_name))
    ):
        return BIBLE_BOOKS[book_name][chapter - 1]
    return 0
